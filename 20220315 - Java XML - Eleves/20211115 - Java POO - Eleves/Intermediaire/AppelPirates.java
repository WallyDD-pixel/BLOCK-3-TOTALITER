...
public class AppelPirates {
    public static void main(String[] args) {
        ...
        corvette.ajouterMarin(premierMarin);
        corvette.ajouterMarin(premierMarin);
        corvette.ajouterMarin(deuxiemeMarin);
        corvette.ajouterMarin(monCapitaineMarin);

        System.out.println("taille équipage: "+corvette.getEquipage().size()) ;
